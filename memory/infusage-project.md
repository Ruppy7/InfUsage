...
- OpenCode Go provider slice is in progress: Rust reads local `opencode.db` spend/tokens read-only; quota/session-cookie flow is deferred. User's current OpenCode DB is in WSL Ubuntu at `/home/ruppy/.local/share/opencode/opencode.db`.
