...
> [!NOTE]
> **Development is paused.** LimitLens remains a working Windows utility, but active development is paused because [Orca](https://www.onorca.dev/) now covers the day-to-day agent workflow, including usage and rate-limit tracking. Newcomers looking for an actively developed all-in-one agent environment can visit the [Orca GitHub repository](https://github.com/stablyai/orca).
